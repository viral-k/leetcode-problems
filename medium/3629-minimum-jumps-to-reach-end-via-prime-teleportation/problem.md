...
At index i = 1, nums[1] = 2 is prime, so teleport to index 3 because nums[3] = 6 is divisible by 2.
...
Explanation:
Start at index i = 0. Take an adjacent step to index 1.
At index i = 1, nums[1] = 3 is prime, so teleport to index 4 because nums[4] = 9 is divisible by 3.
Thus, the answer is 2.
```
